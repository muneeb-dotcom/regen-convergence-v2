...
def load_and_zscore(counts_csv, meta_csv, genes, label_map, label_col, meta_index_match=True):
    ...
    print(counts_csv, "genes found:", present)
...
X.to_csv("data/processed/ml_feature_matrix_X.csv")
y.to_csv("data/processed/ml_feature_matrix_y.csv")